...
void DataProvider::renameGroup(const string &oldName,
...
void DataProvider::updateRomHeaderInfo(
    const string &sha1, const string &name, uint crc32,
    const N64InputTypes &inputTypes) noexcept {
  static SqlCommand s_cmd(R"#(
UPDATE ROMS SET
	internal_name = ?2,
	crc32 = ?3,
...
void DataProvider::updateRomEmulator(const string &sha1,
                                     EmulatorCore core) noexcept {
  static SqlCommand s_cmd(R"#(
UPDATE ROMS
SET emulator = ?2
WHERE sha1 = ?1
...
void DataProvider::updateRomParallelPlugin(const string &sha1,
                                           GfxPlugin plugin) noexcept {
  static SqlCommand s_cmd(R"#(
UPDATE ROMS
...
void DataProvider::updateRomMupenPlugin(const string &sha1,
                                        GfxPlugin plugin) noexcept {
  static SqlCommand s_cmd(R"#(
UPDATE ROMS
SET mupen_plugin = ?2
...
void DataProvider::updateRomCpuOverclocking(const string &sha1,
                                            bool overclock) noexcept {
  static SqlCommand s_cmd(R"#(
UPDATE ROMS
SET overclock_cpu = ?2
WHERE sha1 = ?1
...
void DataProvider::updateRomViOverclocking(const string &sha1,
                                           bool overclock) noexcept {
  static SqlCommand s_cmd(R"#(
UPDATE ROMS
SET overclock_vi = ?2
...
void DataProvider::updateRomWidescreen(const string &sha1,
                                       WidescreenMode widescreen) noexcept {
  static SqlCommand s_cmd(R"#(
UPDATE ROMS
SET widescreen = ?2
WHERE sha1 = ?1
...
void DataProvider::updateRomBigEeprom(const string &sha1,
                                      bool bigEeprom) noexcept {
  static SqlCommand s_cmd(R"#(
UPDATE ROMS
SET big_eeprom = ?2
WHERE sha1 = ?1
...
void DataProvider::updateRomUseInterpreter(const string &sha1,
                                           bool useInterpreter) noexcept {
  static SqlCommand s_cmd(R"#(
UPDATE ROMS
...
void DataProvider::updateRomInputMode(const string &sha1,
                                      const Uuid &inputModeId) noexcept {
  static SqlCommand s_cmd(R"#(
UPDATE ROMS
SET input_mode_id = ?2
WHERE sha1 = ?1
...
void DataProvider::updatePlayTime(const string &sha1, int64 lastPlayed,
                                  int64 playTime) noexcept {
  static SqlCommand s_cmd(R"#(
UPDATE ROMS SET
	last_played = ?2,
	play_time = ?3
...
void DataProvider::updateSdCard(const string &sha1,
                                const string &card) noexcept {
  static SqlCommand s_cmd(R"#(
UPDATE ROMS
SET sd_card = ?2
WHERE sha1 = ?1
...
void DataProvider::updatePluginSettings(
    const string &sha1, EmulatorCore core, GfxPlugin parallelPlugin,
    GfxPlugin mupenPlugin, bool upscaleTexrects, bool removeBorders,
    bool emulateFramebuffer, bool accurateDepthCompare,
...
bool DataProvider::tryFetchRomByHash(const string &sha1, bool includeGroups,
                                     RomInfo *romInfo) noexcept {
...
WHERE sha1 = ?1
  ...
  SqlCommand &cmd = (includeGroups && romInfo != nullptr) ? s_cmdWithGroups
                                                          : s_cmdWithoutGroups;
...
bool DataProvider::tryFetchRomByPath(const fs::path &filePath,
                                     bool includeGroups, RomInfo *romInfo,
                                     RomFile *romFile) {
  static SqlCommand s_cmdWithoutGroups(R"#(
...
bool DataProvider::tryFetchRomPathWithSha1(const string &sha1,
                                           fs::path &filePath) {
  static SqlCommand s_cmd(R"#(
SELECT path
FROM ROMS INNER JOIN ROM_PATHS USING( sha1 )
...
bool DataProvider::tryFetchRomFileWithSha1(const string &sha1,
                                           const string &playlistHint,
                                           RomFile *romFile) {
  static SqlCommand s_cmd(R"#(
...
END DESC
  ...
  while (results.moveNext()) {
    ...
    if (romFile->local && fs::existsSafe(romFile->path))
      return true;
  }
...
FROM ROM_PATHS INNER JOIN ROMS USING( sha1 )
  ...
  DataRecordIterator iterator = s_cmd.execQuery();
  while (iterator.moveNext()) {
    results.push_back({iterator.getPath(0), iterator.getLong(1),
                       iterator.getString(2), iterator.getBool(3)});
  }
...
void DataProvider::cloneRomInfo(const string &oldSha1, const string &newSha1,
                                const string &internalName, uint crc32,
                                const N64InputTypes &inputTypes) noexcept {
  static SqlBatch s_cmd(R"#(
INSERT OR IGNORE INTO ROMS(
...
void DataProvider::addToGroup(const string &sha1,
                              const string &groupName) noexcept {
  static SqlCommand s_cmd(R"#(
INSERT OR IGNORE INTO ROM_GROUPS( sha1, group_name )
VALUES( ?1, ?2 )
)#");
...
void DataProvider::removeFromGroup(const string &sha1,
                                   const string &groupName) noexcept {
  static SqlCommand s_cmd(R"#(
DELETE FROM ROM_GROUPS
WHERE sha1 = ?1
...
void DataProvider::setRomParallelTexRectUpscaling(const string &sha1,
...
void DataProvider::setRomParallelRemoveBorders(const string &sha1,
                                               bool enabled) noexcept {
  static SqlCommand s_cmd(R"#(
UPDATE ROMS
...
void DataProvider::setRomGlidenFrameBufferEmulation(const string &sha1,
                                                    bool enabled) noexcept {
  static SqlCommand s_cmd(R"#(
UPDATE ROMS
...
void DataProvider::setRomGlidenAccurateDepthCompare(const string &sha1,
                                                    bool enabled) noexcept {
  static SqlCommand s_cmd(R"#(
UPDATE ROMS
...
void DataProvider::setRomGlidenRspEmulation(const string &sha1,
                                            bool enabled) noexcept {
  static SqlCommand s_cmd(R"#(
UPDATE ROMS
...
void DataProvider::registerLibplSdCard(const string &uid,
                                       const string &name) noexcept {
  static SqlCommand s_cmd(
      "INSERT OR REPLACE INTO LIBPL_SD_CARDS( uid, name ) VALUES( ?1, ?2 )");
  s_cmd.addParameter(uid, DATA_REF);
  s_cmd.addParameter(name, DATA_REF);
  s_cmd.execNonQuery();
}
...
void DataProvider::addRhdcHackVersion(const string &hackId, const string &sha1,
                                      const string &name, int sortOrder,
                                      GfxPlugin recommendedPlugin,
                                      RhdcHackFlag hackFlags,
                                      bool archived) noexcept {
  static SqlCommand s_cmd(R"#(
...
void DataProvider::addRhdcHackAuthor(const string &hackId,
                                     const string &author) noexcept {
  static SqlCommand s_cmd(R"#(
...
void DataProvider::updateRhdcProgress(
    const string &hackId, const RhdcHackProgress &progress) noexcept {
  static SqlCommand s_cmd(R"#(
...
void DataProvider::updateRhdcHackRating(const string &hackId,
                                        RhdcRating quality,
                                        ubyte difficulty) noexcept {
  static SqlCommand s_cmd(R"#(
...
void DataProvider::updateRhdcStarProgress(const string &hackId, ushort stars,
...
void DataProvider::suggestRhdcHackPlayTime(const string &hackId,
                                           int64 playTime) noexcept {
  static SqlCommand s_cmd(R"#(
UPDATE ROMS
SET play_time = ?2
...
FROM RHDC_HACKS LEFT JOIN RHDC_HACK_PROGRESS USING( id )
  ...
  while (iterator.moveNext()) {
    ...
    hackMap[hackId] = BasicRhdcHack{
        BasicRhdcHackInfo{hackId, iterator.getString(1), iterator.getInt(2),
                          iterator.getString(3) == "Kaizo",
                          iterator.getBool(8)},
        iterator.isNull(4) ? RhdcHackProgress{RhdcRating::NotRated, 0, 0, false}
                           : RhdcHackProgress{(RhdcRating)iterator.getUInt(4),
...
GROUP BY( id )
  ...
  while (iterator.moveNext()) {
    starpowerMap[iterator.getString(0)] = StarpowerExt{
        RhdcHackProgress{(RhdcRating)iterator.getUInt(1),
                         (ubyte)iterator.getInt(2), (ushort)iterator.getInt(3),
                         iterator.getBool(4)},
        iterator.getLong(5), iterator.getInt(6)};
  }

  return starpowerMap;
}

bool DataProvider::tryFetchRhdcHackByChecksum(const string &sha1,
                                              RhdcHack *hack) noexcept {
  static SqlCommand s_cmd(R"#(
SELECT
	id,
	name,
...
WHERE sha1 = ?1
  ...
  hack->info = RhdcHackInfo{iterator.getString(0), iterator.getString(1),
                            iterator.getString(2), iterator.getString(3),
                            iterator.getInt(4),    iterator.getInt(5),
                            iterator.getFloat(6),  iterator.getFloat(7),
                            iterator.getString(8), iterator.getBool(13)};

  if (iterator.isNull(9)) {
    hack->progress = RhdcHackProgress{RhdcRating::NotRated, 0, 0, false};
  } else {
    hack->progress = RhdcHackProgress{
        (RhdcRating)iterator.getUInt(9), (ubyte)iterator.getInt(10),
        (ushort)iterator.getInt(11), iterator.getBool(12)};
  }

  return true;
}

bool DataProvider::tryFetchHackIdByChecksum(const string &sha1,
                                            string &hackId) noexcept {
  static SqlCommand s_cmd(R"#(
...
void DataProvider::addRhdcHackToGroup(const string &hackId,
                                      const string &groupName) noexcept {
  static SqlCommand s_cmd(R"#(
INSERT OR IGNORE INTO ROM_GROUPS( sha1, group_name )
...
void DataProvider::removeRhdcHackFromGroup(const string &hackId,
                                           const string &groupName) noexcept {
  static SqlCommand s_cmd(R"#(
DELETE FROM ROM_GROUPS
WHERE sha1 IN (
...
static std::vector<RhdcHackExt>
readExtRhdcHacks(DataRecordIterator &&iterator) {
  ...
  while (iterator.moveNext()) {
    ...
    results.push_back(
        {RhdcHackInfo{iterator.getString(0), iterator.getString(1),
                      iterator.getString(2), iterator.getString(3),
                      iterator.getInt(4), iterator.getInt(5),
                      iterator.getFloat(6), iterator.getFloat(7),
                      iterator.getString(8), iterator.getBool(9)},
         std::move(progress), std::move(authors), iterator.getLong(15),
         iterator.getLong(16)});
  }
  return results;
}

std::vector<RhdcHackExt>
DataProvider::fetchExtRhdcHacks(const string &searchText) {
  static SqlCommand s_cmd(R"#(
SELECT
...
std::vector<RhdcHackExt>
DataProvider::fetchExtRhdcHacksInList(const string &playlist,
...
std::vector<RhdcHackVersion>
DataProvider::fetchRhdcHackVersions(const string &hackId) {
  static SqlCommand s_cmd(R"#(
...
FROM RHDC_HACK_VERSIONS
  ...
  DataRecordIterator iterator = s_cmd.execQuery();
  while (iterator.moveNext()) {
    versions.push_back({iterator.getString(0), iterator.getString(1),
                        (GfxPlugin)iterator.getInt(2),
                        (RhdcHackFlag)iterator.getInt(3), iterator.getBool(4)});
  }
...
std::vector<fs::path>
DataProvider::fetchRomPathsForRhdcHack(const string &hackId) {
  static SqlCommand s_cmd(R"#(
...
void DataProvider::setLastPlayedVersion(const string &hackId,
                                        const string &sha1) noexcept {
  static SqlCommand s_cmd(R"#(
...
ORDER BY ROWID DESC
  ...
  DataRecordIterator iterator = s_cmd.execQuery();
  while (iterator.moveNext()) {
    logs.push_back({(LogLevel)iterator.getInt(0), iterator.getLong(1),
...
WHERE sha1 = ?1
  ...
  DataRecordIterator iterator = s_cmd.execQuery();
  if (iterator.moveNext()) {
    return {(GfxPlugin)iterator.getInt(0), (RhdcHackFlag)iterator.getInt(1)};
  }
...
string
DataProvider::getVersionNameFromRomPath(const fs::path &romPath) noexcept {
  static SqlCommand s_cmd(R"#(
SELECT version_name
FROM ROM_PATHS
INNER JOIN RHDC_HACK_VERSIONS USING( sha1 )
...
void DataProvider::addPendingPluginCheck(const string &sha1,
                                         bool force) noexcept {
  if (!force) {
...
bool DataProvider::tryGetSaveGroup(const string &sha1,
                                   string &hackId) noexcept {
  static SqlCommand s_cmd(R"#(
...
bool DataProvider::tryGetSaveGroupForRomPath(const fs::path &romPath,
                                             string &hackId) noexcept {
  static SqlCommand s_cmd(R"#(
...
void DataProvider::removeFromSaveGroup(const string &hackId,
                                       const string &sha1) noexcept {
  static SqlCommand s_cmd(R"#(
...
WHERE sent_at IS NULL
  ...
  DataRecordIterator iterator = s_cmd.execQuery();
  while (iterator.moveNext())
    reports[iterator.getLong(0)] = iterator.getString(1);
  return reports;
}

std::map<int64, string>
DataProvider::getCrashLogsForVersion(const Version &appVersion) {
  static SqlCommand s_cmd(R"#(
SELECT crash_date, report FROM CRASH_LOGS
WHERE report LIKE ?1
AND report NOT LIKE '%[Warning]%'
)#");
  s_cmd.addParameter("%AppVersion = "s + appVersion.toString() + '%',
                     DATA_COPY);
