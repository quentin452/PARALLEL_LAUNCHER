...
extern void updateRomHeaderInfo(const string &sha1, const string &name,
                                uint crc32,
                                const N64InputTypes &inputTypes) noexcept;
extern void updateRomEmulator(const string &sha1, EmulatorCore core) noexcept;
extern void updateRomParallelPlugin(const string &sha1,
                                    GfxPlugin plugin) noexcept;
extern void updateRomMupenPlugin(const string &sha1, GfxPlugin plugin) noexcept;
extern void updateRomCpuOverclocking(const string &sha1,
                                     bool overclock) noexcept;
extern void updateRomViOverclocking(const string &sha1,
                                    bool overclock) noexcept;
extern void updateRomWidescreen(const string &sha1,
                                WidescreenMode widescreen) noexcept;
extern void updateRomBigEeprom(const string &sha1, bool bigEeprom) noexcept;
extern void updateRomUseInterpreter(const string &sha1,
                                    bool useInterpreter) noexcept;
extern void updateRomInputMode(const string &sha1,
                               const Uuid &inputModeId) noexcept;
extern void updatePlayTime(const string &sha1, int64 lastPlayed,
...
extern void updatePluginSettings(const string &sha1, EmulatorCore core,
                                 GfxPlugin parallelPlugin,
                                 GfxPlugin mupenPlugin, bool upscaleTexrects,
                                 bool removeBorders, bool emulateFramebuffer,
                                 bool accurateDepthCompare,
                                 bool glidenParallelRsp);

extern bool tryFetchRomByHash(const string &sha1, bool includeGroups,
                              RomInfo *romInfo) noexcept;
extern bool tryFetchRomByPath(const fs::path &filePath, bool includeGroups,
                              RomInfo *romInfo, RomFile *romFile = nullptr);
...
extern bool tryFetchRomFileWithSha1(const string &sha1,
...
extern void cloneRomInfo(const string &oldSha1, const string &newSha1,
...
extern void removeFromGroup(const string &sha1,
                            const string &groupName) noexcept;

extern void setRomParallelTexRectUpscaling(const string &sha1,
                                           bool enabled) noexcept;
extern void setRomParallelRemoveBorders(const string &sha1,
                                        bool enabled) noexcept;
extern void setRomGlidenFrameBufferEmulation(const string &sha1,
                                             bool enabled) noexcept;
extern void setRomGlidenAccurateDepthCompare(const string &sha1,
                                             bool enabled) noexcept;
...
extern void addPendingPluginCheck(const string &sha1,
...
extern void addRhdcHackAuthor(const string &hackId,
                              const string &author) noexcept;
extern void clearRhdcHackVersions(const string &hackId) noexcept;
extern void addRhdcHackVersion(const string &hackId, const string &sha1,
                               const string &name, int sortOrder,
                               GfxPlugin recommendedPlugin,
                               RhdcHackFlag hackFlags, bool archived) noexcept;

extern void clearRhdcHacks() noexcept;
extern void removeOnlineRom(const string &hackId) noexcept;

extern void updateRhdcProgress(const string &hackId,
                               const RhdcHackProgress &progress) noexcept;
extern void updateRhdcHackRating(const string &hackId, RhdcRating quality,
                                 ubyte difficulty) noexcept;
extern void updateRhdcStarProgress(const string &hackId, ushort stars,
                                   bool completed) noexcept;
extern void suggestRhdcHackPlayTime(const string &hackId,
                                    int64 playTime) noexcept;
...
extern bool tryFetchRhdcHackByChecksum(const string &sha1,
                                       RhdcHack *hack) noexcept;
extern bool tryFetchHackIdByChecksum(const string &sha1,
                                     string &hackId) noexcept;

extern std::set<string> fetchGroupsForRhdcHack(const string &hackId);
extern void addRhdcHackToGroup(const string &hackId,
                               const string &groupName) noexcept;
extern void removeRhdcHackFromGroup(const string &hackId,
                                    const string &groupName) noexcept;
...
extern std::vector<RhdcHackExt>
fetchExtRhdcHacksInList(const string &playlist, const string &searchText);
...
extern void setLastPlayedVersion(const string &hackId,
...
extern bool tryGetSaveGroupForRomPath(const fs::path &romPath,
                                      string &hackId) noexcept;
...
extern void removeFromSaveGroup(const string &hackId,
                                const string &sha1) noexcept;
...
extern std::map<int64, string>
getCrashLogsForVersion(const Version &appVersion);
