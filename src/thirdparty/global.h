...
public:
  ...
  // these two add sizeof(WCHAR) 00s after the actual data, so you can cast it
  // to LPCWSTR
...
public:
  ...
  static bool write(LPCWSTR filename,
                    struct mem data); // provided by Flips core
