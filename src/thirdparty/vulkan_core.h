...
// #define VK_API_VERSION VK_MAKE_API_VERSION(0, 1, 0, 0) // Patch version
...
static const VkFormatFeatureFlagBits2
    VK_FORMAT_FEATURE_2_FRAGMENT_SHADING_RATE_ATTACHMENT_BIT_KHR =
        0x40000000ULL;
static const VkFormatFeatureFlagBits2
    VK_FORMAT_FEATURE_2_HOST_IMAGE_TRANSFER_BIT_EXT = 0x400000000000ULL;
static const VkFormatFeatureFlagBits2
...
// VK_KHR_display_swapchain is a preprocessor guard. Do not pass it to API
// calls.
...
// VK_KHR_sampler_mirror_clamp_to_edge is a preprocessor guard. Do not pass it
// to API calls.
...
// VK_KHR_video_decode_queue is a preprocessor guard. Do not pass it to API
// calls.
...
// VK_KHR_dynamic_rendering is a preprocessor guard. Do not pass it to API
// calls.
...
// VK_KHR_get_physical_device_properties2 is a preprocessor guard. Do not pass
// it to API calls.
...
// VK_KHR_shader_draw_parameters is a preprocessor guard. Do not pass it to API
// calls.
...
// VK_KHR_device_group_creation is a preprocessor guard. Do not pass it to API
// calls.
...
// VK_KHR_external_memory_capabilities is a preprocessor guard. Do not pass it
// to API calls.
...
// VK_KHR_external_memory_fd is a preprocessor guard. Do not pass it to API
// calls.
...
// VK_KHR_external_semaphore_capabilities is a preprocessor guard. Do not pass
// it to API calls.
...
// VK_KHR_external_semaphore is a preprocessor guard. Do not pass it to API
// calls.
...
// VK_KHR_external_semaphore_fd is a preprocessor guard. Do not pass it to API
// calls.
...
// VK_KHR_shader_float16_int8 is a preprocessor guard. Do not pass it to API
// calls.
...
// VK_KHR_incremental_present is a preprocessor guard. Do not pass it to API
// calls.
...
// VK_KHR_descriptor_update_template is a preprocessor guard. Do not pass it to
// API calls.
...
// VK_KHR_imageless_framebuffer is a preprocessor guard. Do not pass it to API
// calls.
...
// VK_KHR_create_renderpass2 is a preprocessor guard. Do not pass it to API
// calls.
...
// VK_KHR_shared_presentable_image is a preprocessor guard. Do not pass it to
// API calls.
...
// VK_KHR_external_fence_capabilities is a preprocessor guard. Do not pass it to
// API calls.
...
// VK_KHR_external_fence_fd is a preprocessor guard. Do not pass it to API
// calls.
...
// VK_KHR_performance_query is a preprocessor guard. Do not pass it to API
// calls.
...
// VK_KHR_get_surface_capabilities2 is a preprocessor guard. Do not pass it to
// API calls.
...
// VK_KHR_variable_pointers is a preprocessor guard. Do not pass it to API
// calls.
...
// VK_KHR_get_display_properties2 is a preprocessor guard. Do not pass it to API
// calls.
...
// VK_KHR_dedicated_allocation is a preprocessor guard. Do not pass it to API
// calls.
...
// VK_KHR_storage_buffer_storage_class is a preprocessor guard. Do not pass it
// to API calls.
...
// VK_KHR_relaxed_block_layout is a preprocessor guard. Do not pass it to API
// calls.
#define VK_KHR_relaxed_block_layout 1
#define VK_KHR_RELAXED_BLOCK_LAYOUT_SPEC_VERSION 1
#define VK_KHR_RELAXED_BLOCK_LAYOUT_EXTENSION_NAME "VK_KHR_relaxed_block_layout"

// VK_KHR_get_memory_requirements2 is a preprocessor guard. Do not pass it to
// API calls.
...
// VK_KHR_image_format_list is a preprocessor guard. Do not pass it to API
// calls.
...
// VK_KHR_sampler_ycbcr_conversion is a preprocessor guard. Do not pass it to
// API calls.
...
// VK_KHR_draw_indirect_count is a preprocessor guard. Do not pass it to API
// calls.
...
// VK_KHR_shader_subgroup_extended_types is a preprocessor guard. Do not pass it
// to API calls.
...
// VK_KHR_shader_atomic_int64 is a preprocessor guard. Do not pass it to API
// calls.
...
// VK_KHR_driver_properties is a preprocessor guard. Do not pass it to API
// calls.
...
// VK_KHR_shader_float_controls is a preprocessor guard. Do not pass it to API
// calls.
...
// VK_KHR_depth_stencil_resolve is a preprocessor guard. Do not pass it to API
// calls.
...
// VK_KHR_swapchain_mutable_format is a preprocessor guard. Do not pass it to
// API calls.
...
// VK_KHR_timeline_semaphore is a preprocessor guard. Do not pass it to API
// calls.
...
// VK_KHR_vulkan_memory_model is a preprocessor guard. Do not pass it to API
// calls.
...
// VK_KHR_shader_terminate_invocation is a preprocessor guard. Do not pass it to
// API calls.
...
// VK_KHR_fragment_shading_rate is a preprocessor guard. Do not pass it to API
// calls.
...
// VK_KHR_dynamic_rendering_local_read is a preprocessor guard. Do not pass it
// to API calls.
...
typedef void(VKAPI_PTR *PFN_vkCmdSetRenderingAttachmentLocationsKHR)(
    VkCommandBuffer commandBuffer,
    const VkRenderingAttachmentLocationInfoKHR *pLocationInfo);
typedef void(VKAPI_PTR *PFN_vkCmdSetRenderingInputAttachmentIndicesKHR)(
    VkCommandBuffer commandBuffer,
...
// VK_KHR_shader_quad_control is a preprocessor guard. Do not pass it to API
// calls.
...
// VK_KHR_surface_protected_capabilities is a preprocessor guard. Do not pass it
// to API calls.
...
// VK_KHR_separate_depth_stencil_layouts is a preprocessor guard. Do not pass it
// to API calls.
...
// VK_KHR_uniform_buffer_standard_layout is a preprocessor guard. Do not pass it
// to API calls.
...
// VK_KHR_buffer_device_address is a preprocessor guard. Do not pass it to API
// calls.
...
// VK_KHR_deferred_host_operations is a preprocessor guard. Do not pass it to
// API calls.
...
// VK_KHR_pipeline_executable_properties is a preprocessor guard. Do not pass it
// to API calls.
...
// VK_KHR_shader_integer_dot_product is a preprocessor guard. Do not pass it to
// API calls.
...
// VK_KHR_shader_non_semantic_info is a preprocessor guard. Do not pass it to
// API calls.
...
// VK_KHR_video_encode_queue is a preprocessor guard. Do not pass it to API
// calls.
...
typedef VkResult(
    VKAPI_PTR *PFN_vkGetPhysicalDeviceVideoEncodeQualityLevelPropertiesKHR)(
    VkPhysicalDevice physicalDevice,
...
typedef VkResult(VKAPI_PTR *PFN_vkGetEncodedVideoSessionParametersKHR)(
    ...
    size_t *pDataSize, void *pData);
typedef void(VKAPI_PTR *PFN_vkCmdEncodeVideoKHR)(
...
// VK_KHR_fragment_shader_barycentric is a preprocessor guard. Do not pass it to
// API calls.
...
// VK_KHR_shader_subgroup_uniform_control_flow is a preprocessor guard. Do not
...
// VK_KHR_zero_initialize_workgroup_memory is a preprocessor guard. Do not pass
// it to API calls.
...
// VK_KHR_workgroup_memory_explicit_layout is a preprocessor guard. Do not pass
// it to API calls.
...
// VK_KHR_format_feature_flags2 is a preprocessor guard. Do not pass it to API
// calls.
...
// VK_KHR_ray_tracing_maintenance1 is a preprocessor guard. Do not pass it to
// API calls.
...
// VK_KHR_portability_enumeration is a preprocessor guard. Do not pass it to API
// calls.
...
// VK_KHR_shader_subgroup_rotate is a preprocessor guard. Do not pass it to API
// calls.
#define VK_KHR_shader_subgroup_rotate 1
#define VK_KHR_SHADER_SUBGROUP_ROTATE_SPEC_VERSION 2
#define VK_KHR_SHADER_SUBGROUP_ROTATE_EXTENSION_NAME                           \
...
// VK_KHR_shader_maximal_reconvergence is a preprocessor guard. Do not pass it
// to API calls.
#define VK_KHR_shader_maximal_reconvergence 1
#define VK_KHR_SHADER_MAXIMAL_RECONVERGENCE_SPEC_VERSION 1
#define VK_KHR_SHADER_MAXIMAL_RECONVERGENCE_EXTENSION_NAME                     \
...
static const VkPipelineCreateFlagBits2KHR
...
static const VkPipelineCreateFlagBits2KHR
    VK_PIPELINE_CREATE_2_ENABLE_LEGACY_DITHERING_BIT_EXT = 0x400000000ULL;
static const VkPipelineCreateFlagBits2KHR
    VK_PIPELINE_CREATE_2_VIEW_INDEX_FROM_DEVICE_INDEX_BIT_KHR = 0x00000008ULL;
static const VkPipelineCreateFlagBits2KHR
    VK_PIPELINE_CREATE_2_DISPATCH_BASE_BIT_KHR = 0x00000010ULL;
static const VkPipelineCreateFlagBits2KHR
    VK_PIPELINE_CREATE_2_DEFER_COMPILE_BIT_NV = 0x00000020ULL;
static const VkPipelineCreateFlagBits2KHR
    VK_PIPELINE_CREATE_2_CAPTURE_STATISTICS_BIT_KHR = 0x00000040ULL;
static const VkPipelineCreateFlagBits2KHR
...
static const VkPipelineCreateFlagBits2KHR
    VK_PIPELINE_CREATE_2_FAIL_ON_PIPELINE_COMPILE_REQUIRED_BIT_KHR =
        0x00000100ULL;
static const VkPipelineCreateFlagBits2KHR
    VK_PIPELINE_CREATE_2_EARLY_RETURN_ON_FAILURE_BIT_KHR = 0x00000200ULL;
static const VkPipelineCreateFlagBits2KHR
    VK_PIPELINE_CREATE_2_LINK_TIME_OPTIMIZATION_BIT_EXT = 0x00000400ULL;
static const VkPipelineCreateFlagBits2KHR
...
static const VkPipelineCreateFlagBits2KHR VK_PIPELINE_CREATE_2_LIBRARY_BIT_KHR =
    0x00000800ULL;
static const VkPipelineCreateFlagBits2KHR
    VK_PIPELINE_CREATE_2_RAY_TRACING_SKIP_TRIANGLES_BIT_KHR = 0x00001000ULL;
static const VkPipelineCreateFlagBits2KHR
    VK_PIPELINE_CREATE_2_RAY_TRACING_SKIP_AABBS_BIT_KHR = 0x00002000ULL;
static const VkPipelineCreateFlagBits2KHR
...
static const VkPipelineCreateFlagBits2KHR
    VK_PIPELINE_CREATE_2_RAY_TRACING_SHADER_GROUP_HANDLE_CAPTURE_REPLAY_BIT_KHR =
        0x00080000ULL;
static const VkPipelineCreateFlagBits2KHR
    VK_PIPELINE_CREATE_2_INDIRECT_BINDABLE_BIT_NV = 0x00040000ULL;
static const VkPipelineCreateFlagBits2KHR
    VK_PIPELINE_CREATE_2_RAY_TRACING_ALLOW_MOTION_BIT_NV = 0x00100000ULL;
static const VkPipelineCreateFlagBits2KHR
...
static const VkPipelineCreateFlagBits2KHR
    VK_PIPELINE_CREATE_2_RENDERING_FRAGMENT_DENSITY_MAP_ATTACHMENT_BIT_EXT =
        0x00400000ULL;
static const VkPipelineCreateFlagBits2KHR
    VK_PIPELINE_CREATE_2_RAY_TRACING_OPACITY_MICROMAP_BIT_EXT = 0x01000000ULL;
static const VkPipelineCreateFlagBits2KHR
    VK_PIPELINE_CREATE_2_COLOR_ATTACHMENT_FEEDBACK_LOOP_BIT_EXT = 0x02000000ULL;
static const VkPipelineCreateFlagBits2KHR
    VK_PIPELINE_CREATE_2_DEPTH_STENCIL_ATTACHMENT_FEEDBACK_LOOP_BIT_EXT =
        0x04000000ULL;
static const VkPipelineCreateFlagBits2KHR
    VK_PIPELINE_CREATE_2_NO_PROTECTED_ACCESS_BIT_EXT = 0x08000000ULL;
static const VkPipelineCreateFlagBits2KHR
    VK_PIPELINE_CREATE_2_PROTECTED_ACCESS_ONLY_BIT_EXT = 0x40000000ULL;
static const VkPipelineCreateFlagBits2KHR
    VK_PIPELINE_CREATE_2_RAY_TRACING_DISPLACEMENT_MICROMAP_BIT_NV =
        0x10000000ULL;
static const VkPipelineCreateFlagBits2KHR
    VK_PIPELINE_CREATE_2_DESCRIPTOR_BUFFER_BIT_EXT = 0x20000000ULL;
...
static const VkBufferUsageFlagBits2KHR
    VK_BUFFER_USAGE_2_SHADER_DEVICE_ADDRESS_BIT_KHR = 0x00020000ULL;
static const VkBufferUsageFlagBits2KHR
...
typedef void(VKAPI_PTR *PFN_vkCmdBindIndexBuffer2KHR)(
    VkCommandBuffer commandBuffer, VkBuffer buffer, VkDeviceSize offset,
    VkDeviceSize size, VkIndexType indexType);
typedef void(VKAPI_PTR *PFN_vkGetRenderingAreaGranularityKHR)(
    VkDevice device, const VkRenderingAreaInfoKHR *pRenderingAreaInfo,
    VkExtent2D *pGranularity);
typedef void(VKAPI_PTR *PFN_vkGetDeviceImageSubresourceLayoutKHR)(
    VkDevice device, const VkDeviceImageSubresourceInfoKHR *pInfo,
    VkSubresourceLayout2KHR *pLayout);
typedef void(VKAPI_PTR *PFN_vkGetImageSubresourceLayout2KHR)(
...
// VK_KHR_ray_tracing_position_fetch is a preprocessor guard. Do not pass it to
// API calls.
#define VK_KHR_ray_tracing_position_fetch 1
#define VK_KHR_RAY_TRACING_POSITION_FETCH_SPEC_VERSION 1
#define VK_KHR_RAY_TRACING_POSITION_FETCH_EXTENSION_NAME                       \
...
// VK_KHR_cooperative_matrix is a preprocessor guard. Do not pass it to API
// calls.
...
typedef VkResult(
    VKAPI_PTR *PFN_vkGetPhysicalDeviceCooperativeMatrixPropertiesKHR)(
    VkPhysicalDevice physicalDevice, uint32_t *pPropertyCount,
...
// VK_KHR_video_maintenance1 is a preprocessor guard. Do not pass it to API
// calls.
...
// VK_KHR_vertex_attribute_divisor is a preprocessor guard. Do not pass it to
// API calls.
#define VK_KHR_vertex_attribute_divisor 1
#define VK_KHR_VERTEX_ATTRIBUTE_DIVISOR_SPEC_VERSION 1
#define VK_KHR_VERTEX_ATTRIBUTE_DIVISOR_EXTENSION_NAME                         \
...
// VK_KHR_load_store_op_none is a preprocessor guard. Do not pass it to API
// calls.
...
// VK_KHR_shader_float_controls2 is a preprocessor guard. Do not pass it to API
// calls.
...
// VK_KHR_line_rasterization is a preprocessor guard. Do not pass it to API
// calls.
...
typedef void(VKAPI_PTR *PFN_vkCmdSetLineStippleKHR)(
...
// VK_KHR_calibrated_timestamps is a preprocessor guard. Do not pass it to API
// calls.
#define VK_KHR_calibrated_timestamps 1
#define VK_KHR_CALIBRATED_TIMESTAMPS_SPEC_VERSION 1
#define VK_KHR_CALIBRATED_TIMESTAMPS_EXTENSION_NAME                            \
...
typedef VkResult(VKAPI_PTR *PFN_vkGetCalibratedTimestampsKHR)(
...
// VK_KHR_shader_expect_assume is a preprocessor guard. Do not pass it to API
// calls.
...
typedef void(VKAPI_PTR *PFN_vkCmdPushConstants2KHR)(
    VkCommandBuffer commandBuffer,
    const VkPushConstantsInfoKHR *pPushConstantsInfo);
typedef void(VKAPI_PTR *PFN_vkCmdPushDescriptorSet2KHR)(
    VkCommandBuffer commandBuffer,
    const VkPushDescriptorSetInfoKHR *pPushDescriptorSetInfo);
typedef void(VKAPI_PTR *PFN_vkCmdPushDescriptorSetWithTemplate2KHR)(
    VkCommandBuffer commandBuffer, const VkPushDescriptorSetWithTemplateInfoKHR
                                       *pPushDescriptorSetWithTemplateInfo);
typedef void(VKAPI_PTR *PFN_vkCmdSetDescriptorBufferOffsets2EXT)(
    VkCommandBuffer commandBuffer,
    const VkSetDescriptorBufferOffsetsInfoEXT *pSetDescriptorBufferOffsetsInfo);
typedef void(VKAPI_PTR *PFN_vkCmdBindDescriptorBufferEmbeddedSamplers2EXT)(
    VkCommandBuffer commandBuffer,
...
VKAPI_ATTR void VKAPI_CALL
vkCmdPushConstants2KHR(VkCommandBuffer commandBuffer,
                       const VkPushConstantsInfoKHR *pPushConstantsInfo);
...
// VK_KHR_shader_relaxed_extended_instruction is a preprocessor guard. Do not
// pass it to API calls.
#define VK_KHR_shader_relaxed_extended_instruction 1
#define VK_KHR_SHADER_RELAXED_EXTENDED_INSTRUCTION_SPEC_VERSION 1
#define VK_KHR_SHADER_RELAXED_EXTENDED_INSTRUCTION_EXTENSION_NAME              \
...
// VK_EXT_depth_range_unrestricted is a preprocessor guard. Do not pass it to
// API calls.
...
// VK_AMD_rasterization_order is a preprocessor guard. Do not pass it to API
// calls.
...
// VK_AMD_shader_trinary_minmax is a preprocessor guard. Do not pass it to API
// calls.
...
// VK_AMD_shader_explicit_vertex_parameter is a preprocessor guard. Do not pass
// it to API calls.
...
// VK_NV_dedicated_allocation is a preprocessor guard. Do not pass it to API
// calls.
...
// VK_EXT_transform_feedback is a preprocessor guard. Do not pass it to API
// calls.
...
// VK_NVX_image_view_handle is a preprocessor guard. Do not pass it to API
// calls.
...
// VK_AMD_draw_indirect_count is a preprocessor guard. Do not pass it to API
// calls.
...
// VK_AMD_negative_viewport_height is a preprocessor guard. Do not pass it to
// API calls.
...
// VK_AMD_gpu_shader_half_float is a preprocessor guard. Do not pass it to API
// calls.
...
// VK_AMD_texture_gather_bias_lod is a preprocessor guard. Do not pass it to API
// calls.
...
// VK_AMD_shader_image_load_store_lod is a preprocessor guard. Do not pass it to
// API calls.
...
// VK_NV_corner_sampled_image is a preprocessor guard. Do not pass it to API
// calls.
...
// VK_NV_external_memory_capabilities is a preprocessor guard. Do not pass it to
// API calls.
...
// VK_EXT_shader_subgroup_ballot is a preprocessor guard. Do not pass it to API
// calls.
...
// VK_EXT_shader_subgroup_vote is a preprocessor guard. Do not pass it to API
// calls.
#define VK_EXT_shader_subgroup_vote 1
#define VK_EXT_SHADER_SUBGROUP_VOTE_SPEC_VERSION 1
#define VK_EXT_SHADER_SUBGROUP_VOTE_EXTENSION_NAME "VK_EXT_shader_subgroup_vote"

// VK_EXT_texture_compression_astc_hdr is a preprocessor guard. Do not pass it
// to API calls.
...
// VK_EXT_pipeline_robustness is a preprocessor guard. Do not pass it to API
// calls.
...
// VK_EXT_conditional_rendering is a preprocessor guard. Do not pass it to API
// calls.
...
// VK_NV_clip_space_w_scaling is a preprocessor guard. Do not pass it to API
// calls.
...
// VK_EXT_direct_mode_display is a preprocessor guard. Do not pass it to API
// calls.
...
// VK_EXT_display_surface_counter is a preprocessor guard. Do not pass it to API
// calls.
...
// VK_GOOGLE_display_timing is a preprocessor guard. Do not pass it to API
// calls.
...
// VK_NV_sample_mask_override_coverage is a preprocessor guard. Do not pass it
// to API calls.
...
// VK_NV_geometry_shader_passthrough is a preprocessor guard. Do not pass it to
// API calls.
...
// VK_NVX_multiview_per_view_attributes is a preprocessor guard. Do not pass it
// to API calls.
...
// VK_EXT_discard_rectangles is a preprocessor guard. Do not pass it to API
// calls.
...
typedef void(VKAPI_PTR *PFN_vkCmdSetDiscardRectangleModeEXT)(
    VkCommandBuffer commandBuffer,
    VkDiscardRectangleModeEXT discardRectangleMode);
...
// VK_EXT_conservative_rasterization is a preprocessor guard. Do not pass it to
// API calls.
...
// VK_EXT_depth_clip_enable is a preprocessor guard. Do not pass it to API
// calls.
...
// VK_EXT_swapchain_colorspace is a preprocessor guard. Do not pass it to API
// calls.
...
// VK_IMG_relaxed_line_rasterization is a preprocessor guard. Do not pass it to
// API calls.
#define VK_IMG_relaxed_line_rasterization 1
#define VK_IMG_RELAXED_LINE_RASTERIZATION_SPEC_VERSION 1
#define VK_IMG_RELAXED_LINE_RASTERIZATION_EXTENSION_NAME                       \
...
// VK_EXT_external_memory_dma_buf is a preprocessor guard. Do not pass it to API
// calls.
...
// VK_EXT_queue_family_foreign is a preprocessor guard. Do not pass it to API
// calls.
...
// VK_EXT_sampler_filter_minmax is a preprocessor guard. Do not pass it to API
// calls.
...
// VK_AMD_mixed_attachment_samples is a preprocessor guard. Do not pass it to
// API calls.
...
// VK_AMD_shader_fragment_mask is a preprocessor guard. Do not pass it to API
// calls.
#define VK_AMD_shader_fragment_mask 1
#define VK_AMD_SHADER_FRAGMENT_MASK_SPEC_VERSION 1
#define VK_AMD_SHADER_FRAGMENT_MASK_EXTENSION_NAME "VK_AMD_shader_fragment_mask"

// VK_EXT_inline_uniform_block is a preprocessor guard. Do not pass it to API
// calls.
...
// VK_EXT_shader_stencil_export is a preprocessor guard. Do not pass it to API
// calls.
...
// VK_EXT_blend_operation_advanced is a preprocessor guard. Do not pass it to
// API calls.
...
// VK_NV_fragment_coverage_to_color is a preprocessor guard. Do not pass it to
// API calls.
...
// VK_NV_framebuffer_mixed_samples is a preprocessor guard. Do not pass it to
// API calls.
...
// VK_NV_shader_sm_builtins is a preprocessor guard. Do not pass it to API
// calls.
...
// VK_EXT_post_depth_coverage is a preprocessor guard. Do not pass it to API
// calls.
#define VK_EXT_post_depth_coverage 1
#define VK_EXT_POST_DEPTH_COVERAGE_SPEC_VERSION 1
#define VK_EXT_POST_DEPTH_COVERAGE_EXTENSION_NAME "VK_EXT_post_depth_coverage"

// VK_EXT_image_drm_format_modifier is a preprocessor guard. Do not pass it to
// API calls.
...
// VK_EXT_descriptor_indexing is a preprocessor guard. Do not pass it to API
// calls.
...
// VK_EXT_shader_viewport_index_layer is a preprocessor guard. Do not pass it to
// API calls.
...
// VK_NV_shading_rate_image is a preprocessor guard. Do not pass it to API
// calls.
...
// VK_NV_representative_fragment_test is a preprocessor guard. Do not pass it to
// API calls.
...
// VK_QCOM_render_pass_shader_resolve is a preprocessor guard. Do not pass it to
// API calls.
...
// VK_EXT_external_memory_host is a preprocessor guard. Do not pass it to API
// calls.
...
// VK_AMD_pipeline_compiler_control is a preprocessor guard. Do not pass it to
// API calls.
...
// VK_EXT_calibrated_timestamps is a preprocessor guard. Do not pass it to API
// calls.
...
// VK_AMD_shader_core_properties is a preprocessor guard. Do not pass it to API
// calls.
...
// VK_AMD_memory_overallocation_behavior is a preprocessor guard. Do not pass it
// to API calls.
...
// VK_EXT_vertex_attribute_divisor is a preprocessor guard. Do not pass it to
// API calls.
...
typedef VkPipelineVertexInputDivisorStateCreateInfoKHR
    VkPipelineVertexInputDivisorStateCreateInfoEXT;

typedef VkPhysicalDeviceVertexAttributeDivisorFeaturesKHR
    VkPhysicalDeviceVertexAttributeDivisorFeaturesEXT;

// VK_EXT_pipeline_creation_feedback is a preprocessor guard. Do not pass it to
// API calls.
...
// VK_NV_shader_subgroup_partitioned is a preprocessor guard. Do not pass it to
// API calls.
...
// VK_NV_compute_shader_derivatives is a preprocessor guard. Do not pass it to
// API calls.
...
// VK_NV_fragment_shader_barycentric is a preprocessor guard. Do not pass it to
// API calls.
...
// VK_NV_shader_image_footprint is a preprocessor guard. Do not pass it to API
// calls.
...
typedef void(VKAPI_PTR *PFN_vkCmdSetExclusiveScissorEnableNV)(
...
// VK_NV_device_diagnostic_checkpoints is a preprocessor guard. Do not pass it
// to API calls.
...
// VK_INTEL_shader_integer_functions2 is a preprocessor guard. Do not pass it to
// API calls.
...
// VK_INTEL_performance_query is a preprocessor guard. Do not pass it to API
// calls.
...
// VK_AMD_display_native_hdr is a preprocessor guard. Do not pass it to API
// calls.
...
// VK_EXT_fragment_density_map is a preprocessor guard. Do not pass it to API
// calls.
...
// VK_EXT_scalar_block_layout is a preprocessor guard. Do not pass it to API
// calls.
...
// VK_GOOGLE_hlsl_functionality1 is a preprocessor guard. Do not pass it to API
// calls.
...
// VK_GOOGLE_decorate_string is a preprocessor guard. Do not pass it to API
// calls.
#define VK_GOOGLE_decorate_string 1
#define VK_GOOGLE_DECORATE_STRING_SPEC_VERSION 1
#define VK_GOOGLE_DECORATE_STRING_EXTENSION_NAME "VK_GOOGLE_decorate_string"

// VK_EXT_subgroup_size_control is a preprocessor guard. Do not pass it to API
// calls.
...
// VK_AMD_shader_core_properties2 is a preprocessor guard. Do not pass it to API
// calls.
...
// VK_AMD_device_coherent_memory is a preprocessor guard. Do not pass it to API
// calls.
...
// VK_EXT_shader_image_atomic_int64 is a preprocessor guard. Do not pass it to
// API calls.
...
// VK_NV_dedicated_allocation_image_aliasing is a preprocessor guard. Do not
// pass it to API calls.
...
// VK_EXT_buffer_device_address is a preprocessor guard. Do not pass it to API
// calls.
...
// VK_EXT_separate_stencil_usage is a preprocessor guard. Do not pass it to API
// calls.
...
// VK_EXT_validation_features is a preprocessor guard. Do not pass it to API
// calls.
...
// VK_NV_cooperative_matrix is a preprocessor guard. Do not pass it to API
// calls.
...
// VK_NV_coverage_reduction_mode is a preprocessor guard. Do not pass it to API
// calls.
...
// VK_EXT_fragment_shader_interlock is a preprocessor guard. Do not pass it to
// API calls.
...
// VK_EXT_ycbcr_image_arrays is a preprocessor guard. Do not pass it to API
// calls.
...
// VK_EXT_line_rasterization is a preprocessor guard. Do not pass it to API
// calls.
...
typedef VkPipelineRasterizationLineStateCreateInfoKHR
...
// VK_EXT_shader_atomic_float is a preprocessor guard. Do not pass it to API
// calls.
...
// VK_EXT_extended_dynamic_state is a preprocessor guard. Do not pass it to API
// calls.
...
typedef VkResult(VKAPI_PTR *PFN_vkCopyMemoryToImageEXT)(
    VkDevice device, const VkCopyMemoryToImageInfoEXT *pCopyMemoryToImageInfo);
typedef VkResult(VKAPI_PTR *PFN_vkCopyImageToMemoryEXT)(
    VkDevice device, const VkCopyImageToMemoryInfoEXT *pCopyImageToMemoryInfo);
typedef VkResult(VKAPI_PTR *PFN_vkCopyImageToImageEXT)(
    VkDevice device, const VkCopyImageToImageInfoEXT *pCopyImageToImageInfo);
typedef VkResult(VKAPI_PTR *PFN_vkTransitionImageLayoutEXT)(
...
// VK_EXT_map_memory_placed is a preprocessor guard. Do not pass it to API
// calls.
...
// VK_EXT_shader_atomic_float2 is a preprocessor guard. Do not pass it to API
// calls.
...
// VK_EXT_surface_maintenance1 is a preprocessor guard. Do not pass it to API
// calls.
...
// VK_EXT_swapchain_maintenance1 is a preprocessor guard. Do not pass it to API
// calls.
...
// VK_EXT_shader_demote_to_helper_invocation is a preprocessor guard. Do not
// pass it to API calls.
...
// VK_NV_device_generated_commands is a preprocessor guard. Do not pass it to
// API calls.
...
// VK_NV_inherited_viewport_scissor is a preprocessor guard. Do not pass it to
// API calls.
...
// VK_EXT_texel_buffer_alignment is a preprocessor guard. Do not pass it to API
// calls.
...
// VK_QCOM_render_pass_transform is a preprocessor guard. Do not pass it to API
// calls.
...
// VK_EXT_depth_bias_control is a preprocessor guard. Do not pass it to API
// calls.
...
typedef void(VKAPI_PTR *PFN_vkCmdSetDepthBias2EXT)(
...
// VK_EXT_device_memory_report is a preprocessor guard. Do not pass it to API
// calls.
...
// VK_EXT_acquire_drm_display is a preprocessor guard. Do not pass it to API
// calls.
...
// VK_EXT_custom_border_color is a preprocessor guard. Do not pass it to API
// calls.
...
// VK_EXT_pipeline_creation_cache_control is a preprocessor guard. Do not pass
// it to API calls.
...
// VK_NV_device_diagnostics_config is a preprocessor guard. Do not pass it to
// API calls.
...
// VK_QCOM_render_pass_store_ops is a preprocessor guard. Do not pass it to API
// calls.
...
// VK_NV_cuda_kernel_launch is a preprocessor guard. Do not pass it to API
// calls.
...
typedef VkResult(VKAPI_PTR *PFN_vkCreateCudaModuleNV)(
    VkDevice device, const VkCudaModuleCreateInfoNV *pCreateInfo,
    const VkAllocationCallbacks *pAllocator, VkCudaModuleNV *pModule);
typedef VkResult(VKAPI_PTR *PFN_vkGetCudaModuleCacheNV)(VkDevice device,
                                                        VkCudaModuleNV module,
                                                        size_t *pCacheSize,
                                                        void *pCacheData);
...
typedef void(VKAPI_PTR *PFN_vkDestroyCudaModuleNV)(
    VkDevice device, VkCudaModuleNV module,
    const VkAllocationCallbacks *pAllocator);
typedef void(VKAPI_PTR *PFN_vkDestroyCudaFunctionNV)(
    VkDevice device, VkCudaFunctionNV function,
    const VkAllocationCallbacks *pAllocator);
typedef void(VKAPI_PTR *PFN_vkCmdCudaLaunchKernelNV)(
    VkCommandBuffer commandBuffer, const VkCudaLaunchInfoNV *pLaunchInfo);
...
VKAPI_ATTR void VKAPI_CALL
vkDestroyCudaModuleNV(VkDevice device, VkCudaModuleNV module,
                      const VkAllocationCallbacks *pAllocator);

VKAPI_ATTR void VKAPI_CALL
vkDestroyCudaFunctionNV(VkDevice device, VkCudaFunctionNV function,
                        const VkAllocationCallbacks *pAllocator);
...
// VK_EXT_descriptor_buffer is a preprocessor guard. Do not pass it to API
// calls.
...
// VK_EXT_graphics_pipeline_library is a preprocessor guard. Do not pass it to
// API calls.
...
// VK_AMD_shader_early_and_late_fragment_tests is a preprocessor guard. Do not
// pass it to API calls.
...
// VK_NV_fragment_shading_rate_enums is a preprocessor guard. Do not pass it to
// API calls.
...
// VK_NV_ray_tracing_motion_blur is a preprocessor guard. Do not pass it to API
// calls.
...
// VK_EXT_ycbcr_2plane_444_formats is a preprocessor guard. Do not pass it to
// API calls.
...
// VK_EXT_fragment_density_map2 is a preprocessor guard. Do not pass it to API
// calls.
...
// VK_QCOM_rotated_copy_commands is a preprocessor guard. Do not pass it to API
// calls.
...
// VK_EXT_image_compression_control is a preprocessor guard. Do not pass it to
// API calls.
...
// VK_EXT_attachment_feedback_loop_layout is a preprocessor guard. Do not pass
// it to API calls.
...
// VK_ARM_rasterization_order_attachment_access is a preprocessor guard. Do not
// pass it to API calls.
...
// VK_VALVE_mutable_descriptor_type is a preprocessor guard. Do not pass it to
// API calls.
...
// VK_EXT_vertex_input_dynamic_state is a preprocessor guard. Do not pass it to
// API calls.
...
// VK_EXT_physical_device_drm is a preprocessor guard. Do not pass it to API
// calls.
...
// VK_EXT_device_address_binding_report is a preprocessor guard. Do not pass it
// to API calls.
...
// VK_EXT_depth_clip_control is a preprocessor guard. Do not pass it to API
// calls.
...
// VK_EXT_primitive_topology_list_restart is a preprocessor guard. Do not pass
// it to API calls.
...
// VK_HUAWEI_subpass_shading is a preprocessor guard. Do not pass it to API
// calls.
...
// VK_HUAWEI_invocation_mask is a preprocessor guard. Do not pass it to API
// calls.
...
// VK_NV_external_memory_rdma is a preprocessor guard. Do not pass it to API
// calls.
...
// VK_EXT_pipeline_properties is a preprocessor guard. Do not pass it to API
// calls.
...
// VK_EXT_multisampled_render_to_single_sampled is a preprocessor guard. Do not
// pass it to API calls.
...
// VK_EXT_extended_dynamic_state2 is a preprocessor guard. Do not pass it to API
// calls.
...
// VK_EXT_color_write_enable is a preprocessor guard. Do not pass it to API
// calls.
...
// VK_EXT_primitives_generated_query is a preprocessor guard. Do not pass it to
// API calls.
...
// VK_EXT_global_priority_query is a preprocessor guard. Do not pass it to API
// calls.
...
// VK_EXT_image_view_min_lod is a preprocessor guard. Do not pass it to API
// calls.
...
// VK_EXT_image_2d_view_of_3d is a preprocessor guard. Do not pass it to API
// calls.
...
// VK_EXT_shader_tile_image is a preprocessor guard. Do not pass it to API
// calls.
...
// VK_EXT_load_store_op_none is a preprocessor guard. Do not pass it to API
// calls.
#define VK_EXT_load_store_op_none 1
#define VK_EXT_LOAD_STORE_OP_NONE_SPEC_VERSION 1
#define VK_EXT_LOAD_STORE_OP_NONE_EXTENSION_NAME "VK_EXT_load_store_op_none"

// VK_HUAWEI_cluster_culling_shader is a preprocessor guard. Do not pass it to
// API calls.
...
// VK_EXT_border_color_swizzle is a preprocessor guard. Do not pass it to API
// calls.
...
// VK_EXT_pageable_device_local_memory is a preprocessor guard. Do not pass it
// to API calls.
...
// VK_ARM_shader_core_properties is a preprocessor guard. Do not pass it to API
// calls.
#define VK_ARM_shader_core_properties 1
#define VK_ARM_SHADER_CORE_PROPERTIES_SPEC_VERSION 1
#define VK_ARM_SHADER_CORE_PROPERTIES_EXTENSION_NAME                           \
...
// VK_ARM_scheduling_controls is a preprocessor guard. Do not pass it to API
// calls.
...
static const VkPhysicalDeviceSchedulingControlsFlagBitsARM
...
// VK_EXT_image_sliced_view_of_3d is a preprocessor guard. Do not pass it to API
// calls.
...
// VK_VALVE_descriptor_set_host_mapping is a preprocessor guard. Do not pass it
// to API calls.
...
// VK_EXT_depth_clamp_zero_one is a preprocessor guard. Do not pass it to API
// calls.
...
// VK_EXT_non_seamless_cube_map is a preprocessor guard. Do not pass it to API
// calls.
...
// VK_ARM_render_pass_striped is a preprocessor guard. Do not pass it to API
// calls.
...
// VK_QCOM_fragment_density_map_offset is a preprocessor guard. Do not pass it
// to API calls.
...
// VK_NV_copy_memory_indirect is a preprocessor guard. Do not pass it to API
// calls.
...
// VK_NV_memory_decompression is a preprocessor guard. Do not pass it to API
// calls.
...
// VK_NV_device_generated_commands_compute is a preprocessor guard. Do not pass
// it to API calls.
...
typedef void(VKAPI_PTR *PFN_vkGetPipelineIndirectMemoryRequirementsNV)(
    VkDevice device, const VkComputePipelineCreateInfo *pCreateInfo,
    VkMemoryRequirements2 *pMemoryRequirements);
typedef void(VKAPI_PTR *PFN_vkCmdUpdatePipelineIndirectBufferNV)(
    VkCommandBuffer commandBuffer, VkPipelineBindPoint pipelineBindPoint,
    VkPipeline pipeline);
typedef VkDeviceAddress(VKAPI_PTR *PFN_vkGetPipelineIndirectDeviceAddressNV)(
...
// VK_NV_linear_color_attachment is a preprocessor guard. Do not pass it to API
// calls.
...
// VK_GOOGLE_surfaceless_query is a preprocessor guard. Do not pass it to API
// calls.
#define VK_GOOGLE_surfaceless_query 1
#define VK_GOOGLE_SURFACELESS_QUERY_SPEC_VERSION 2
#define VK_GOOGLE_SURFACELESS_QUERY_EXTENSION_NAME "VK_GOOGLE_surfaceless_query"

// VK_EXT_image_compression_control_swapchain is a preprocessor guard. Do not
// pass it to API calls.
...
// VK_QCOM_image_processing is a preprocessor guard. Do not pass it to API
// calls.
...
// VK_EXT_nested_command_buffer is a preprocessor guard. Do not pass it to API
// calls.
#define VK_EXT_nested_command_buffer 1
#define VK_EXT_NESTED_COMMAND_BUFFER_SPEC_VERSION 1
#define VK_EXT_NESTED_COMMAND_BUFFER_EXTENSION_NAME                            \
...
// VK_EXT_external_memory_acquire_unmodified is a preprocessor guard. Do not
// pass it to API calls.
#define VK_EXT_external_memory_acquire_unmodified 1
#define VK_EXT_EXTERNAL_MEMORY_ACQUIRE_UNMODIFIED_SPEC_VERSION 1
#define VK_EXT_EXTERNAL_MEMORY_ACQUIRE_UNMODIFIED_EXTENSION_NAME               \
...
// VK_EXT_extended_dynamic_state3 is a preprocessor guard. Do not pass it to API
// calls.
...
// VK_EXT_subpass_merge_feedback is a preprocessor guard. Do not pass it to API
// calls.
...
// VK_LUNARG_direct_driver_loading is a preprocessor guard. Do not pass it to
// API calls.
...
// VK_EXT_shader_module_identifier is a preprocessor guard. Do not pass it to
// API calls.
...
// VK_EXT_rasterization_order_attachment_access is a preprocessor guard. Do not
// pass it to API calls.
...
// VK_EXT_pipeline_protected_access is a preprocessor guard. Do not pass it to
// API calls.
...
typedef void(VKAPI_PTR *PFN_vkDestroyShaderEXT)(
    VkDevice device, VkShaderEXT shader,
    const VkAllocationCallbacks *pAllocator);
typedef VkResult(VKAPI_PTR *PFN_vkGetShaderBinaryDataEXT)(VkDevice device,
                                                          VkShaderEXT shader,
                                                          size_t *pDataSize,
                                                          void *pData);
typedef void(VKAPI_PTR *PFN_vkCmdBindShadersEXT)(
...
VKAPI_ATTR void VKAPI_CALL
vkDestroyShaderEXT(VkDevice device, VkShaderEXT shader,
                   const VkAllocationCallbacks *pAllocator);
...
// VK_QCOM_multiview_per_view_viewports is a preprocessor guard. Do not pass it
// to API calls.
...
// VK_NV_ray_tracing_invocation_reorder is a preprocessor guard. Do not pass it
// to API calls.
...
// VK_NV_extended_sparse_address_space is a preprocessor guard. Do not pass it
// to API calls.
#define VK_NV_extended_sparse_address_space 1
#define VK_NV_EXTENDED_SPARSE_ADDRESS_SPACE_SPEC_VERSION 1
#define VK_NV_EXTENDED_SPARSE_ADDRESS_SPACE_EXTENSION_NAME                     \
...
// VK_EXT_mutable_descriptor_type is a preprocessor guard. Do not pass it to API
// calls.
...
// VK_EXT_legacy_vertex_attributes is a preprocessor guard. Do not pass it to
// API calls.
#define VK_EXT_legacy_vertex_attributes 1
#define VK_EXT_LEGACY_VERTEX_ATTRIBUTES_SPEC_VERSION 1
#define VK_EXT_LEGACY_VERTEX_ATTRIBUTES_EXTENSION_NAME                         \
...
// VK_ARM_shader_core_builtins is a preprocessor guard. Do not pass it to API
// calls.
...
// VK_EXT_pipeline_library_group_handles is a preprocessor guard. Do not pass it
// to API calls.
#define VK_EXT_pipeline_library_group_handles 1
#define VK_EXT_PIPELINE_LIBRARY_GROUP_HANDLES_SPEC_VERSION 1
#define VK_EXT_PIPELINE_LIBRARY_GROUP_HANDLES_EXTENSION_NAME                   \
...
// VK_EXT_dynamic_rendering_unused_attachments is a preprocessor guard. Do not
// pass it to API calls.
#define VK_EXT_dynamic_rendering_unused_attachments 1
#define VK_EXT_DYNAMIC_RENDERING_UNUSED_ATTACHMENTS_SPEC_VERSION 1
#define VK_EXT_DYNAMIC_RENDERING_UNUSED_ATTACHMENTS_EXTENSION_NAME             \
...
typedef VkResult(VKAPI_PTR *PFN_vkLatencySleepNV)(
    VkDevice device, VkSwapchainKHR swapchain,
    const VkLatencySleepInfoNV *pSleepInfo);
typedef void(VKAPI_PTR *PFN_vkSetLatencyMarkerNV)(
    VkDevice device, VkSwapchainKHR swapchain,
    const VkSetLatencyMarkerInfoNV *pLatencyMarkerInfo);
typedef void(VKAPI_PTR *PFN_vkGetLatencyTimingsNV)(
    VkDevice device, VkSwapchainKHR swapchain,
...
VKAPI_ATTR VkResult VKAPI_CALL
vkLatencySleepNV(VkDevice device, VkSwapchainKHR swapchain,
                 const VkLatencySleepInfoNV *pSleepInfo);

VKAPI_ATTR void VKAPI_CALL
vkSetLatencyMarkerNV(VkDevice device, VkSwapchainKHR swapchain,
                     const VkSetLatencyMarkerInfoNV *pLatencyMarkerInfo);

VKAPI_ATTR void VKAPI_CALL
vkGetLatencyTimingsNV(VkDevice device, VkSwapchainKHR swapchain,
                      VkGetLatencyMarkerInfoNV *pLatencyMarkerInfo);
...
// VK_QCOM_multiview_per_view_render_areas is a preprocessor guard. Do not pass
// it to API calls.
#define VK_QCOM_multiview_per_view_render_areas 1
#define VK_QCOM_MULTIVIEW_PER_VIEW_RENDER_AREAS_SPEC_VERSION 1
#define VK_QCOM_MULTIVIEW_PER_VIEW_RENDER_AREAS_EXTENSION_NAME                 \
...
// VK_NV_per_stage_descriptor_set is a preprocessor guard. Do not pass it to API
// calls.
#define VK_NV_per_stage_descriptor_set 1
#define VK_NV_PER_STAGE_DESCRIPTOR_SET_SPEC_VERSION 1
#define VK_NV_PER_STAGE_DESCRIPTOR_SET_EXTENSION_NAME                          \
...
// VK_QCOM_image_processing2 is a preprocessor guard. Do not pass it to API
// calls.
...
// VK_QCOM_filter_cubic_weights is a preprocessor guard. Do not pass it to API
// calls.
#define VK_QCOM_filter_cubic_weights 1
#define VK_QCOM_FILTER_CUBIC_WEIGHTS_SPEC_VERSION 1
#define VK_QCOM_FILTER_CUBIC_WEIGHTS_EXTENSION_NAME                            \
...
// VK_QCOM_filter_cubic_clamp is a preprocessor guard. Do not pass it to API
// calls.
...
// VK_EXT_attachment_feedback_loop_dynamic_state is a preprocessor guard. Do not
// pass it to API calls.
...
typedef void(VKAPI_PTR *PFN_vkCmdSetAttachmentFeedbackLoopEnableEXT)(
...
// VK_NV_descriptor_pool_overallocation is a preprocessor guard. Do not pass it
// to API calls.
#define VK_NV_descriptor_pool_overallocation 1
#define VK_NV_DESCRIPTOR_POOL_OVERALLOCATION_SPEC_VERSION 1
#define VK_NV_DESCRIPTOR_POOL_OVERALLOCATION_EXTENSION_NAME                    \
...
// VK_NV_shader_atomic_float16_vector is a preprocessor guard. Do not pass it to
// API calls.
#define VK_NV_shader_atomic_float16_vector 1
#define VK_NV_SHADER_ATOMIC_FLOAT16_VECTOR_SPEC_VERSION 1
#define VK_NV_SHADER_ATOMIC_FLOAT16_VECTOR_EXTENSION_NAME                      \
...
// VK_EXT_shader_replicated_composites is a preprocessor guard. Do not pass it
// to API calls.
#define VK_EXT_shader_replicated_composites 1
#define VK_EXT_SHADER_REPLICATED_COMPOSITES_SPEC_VERSION 1
#define VK_EXT_SHADER_REPLICATED_COMPOSITES_EXTENSION_NAME                     \
...
// VK_NV_ray_tracing_validation is a preprocessor guard. Do not pass it to API
// calls.
#define VK_NV_ray_tracing_validation 1
#define VK_NV_RAY_TRACING_VALIDATION_SPEC_VERSION 1
#define VK_NV_RAY_TRACING_VALIDATION_EXTENSION_NAME                            \
...
// VK_MESA_image_alignment_control is a preprocessor guard. Do not pass it to
// API calls.
#define VK_MESA_image_alignment_control 1
#define VK_MESA_IMAGE_ALIGNMENT_CONTROL_SPEC_VERSION 1
#define VK_MESA_IMAGE_ALIGNMENT_CONTROL_EXTENSION_NAME                         \
...
// VK_KHR_acceleration_structure is a preprocessor guard. Do not pass it to API
// calls.
...
// VK_KHR_ray_tracing_pipeline is a preprocessor guard. Do not pass it to API
// calls.
