...
DateTimeOffsetEdit::DateTimeOffsetEdit(QWidget *parent)
    : QDateTimeEdit(parent), m_timer(this), m_offset(0), m_ignoreUpdate(false) {
  connect(&m_timer, &QTimer::timeout, this, &DateTimeOffsetEdit::syncDate);
  connect(this, &QDateTimeEdit::dateTimeChanged, this,
          &DateTimeOffsetEdit::syncOffset);
  connect(lineEdit(), &QLineEdit::editingFinished, this,
          &DateTimeOffsetEdit::doneEditing);
}
